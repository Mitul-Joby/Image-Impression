...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Simple Image Resizer')
    parser.add_argument('input', nargs='?', help='Input image')
    parser.add_argument('output', nargs='?', help='Output image')
    parser.add_argument('-f', '--factor', help='Resize Factor', default=4, type=int)
    ...
    newMatrix = compressMatrix(average, args.factor, matrix)
